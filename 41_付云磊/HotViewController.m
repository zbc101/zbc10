...
@interface HotViewController ()<UITableViewDataSource,UITableViewDelegate,MJRefreshBaseViewDelegate>
{
    //表视图
...
- (void)createUI
{
    ...
    UIButton *rightButton = [MyUtil createBtnFrame:CGRectMake(0, 0, 60, 36) title:@"付费" bgImageName:@"navButton" target:self action:@selector(buttonClicked:)];
    rightButton.tag = 201;
    UIBarButtonItem *rightItem = [[UIBarButtonItem alloc] initWithCustomView:rightButton];
    self.navigationItem.rightBarButtonItem = rightItem;

    
    self.navigationItem.title = @"每日一荐";
...
- (void)createAppData
{
    ...
    NSString *urlStr = [NSString stringWithFormat:MYRECOMMENDURL,(NSInteger)10,_page];
